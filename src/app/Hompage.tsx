    ...
    >
        ...
        <div className="md:flex w-ful items-center sm:py-10  mx-[10%] sm:mx-[5%] pt-[2rem]">
            <div className="md:w-[50%] items-center">
                ...
                <button className="flex gap-2 bg-gradient-to-r from-blue-600 to-blue-900 justify-around items-center text-white rounded-xl py-1 px-3" > <p>Learn more</p> <img src={btnarrow} alt="" /> </button>
            </div>
            <img src={coder} />
        </div>
        <div className="md:flex shadow-xl  bg-[#EDF7FF] mx-[10%] sm:mx-[5%] justify-between items-center my-[6rem] rounded-[3rem]">
            <h1 className="text-center  items-center  md:bg-white text-[2rem] font-bold text-[#263A5C] pt-[3rem]  md:ml-5 md:w-[50%] md:h-[10rem] rounded-l-[3rem]">About us</h1>
        ...
        <footer className="bg-[#263A5C] h-[3rem] text-white flex justify-around items-center">
            <img src={logo} alt="" />
